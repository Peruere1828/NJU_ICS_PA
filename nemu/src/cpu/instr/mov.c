...
make_instr_func(mov_rm2s_w){
        ...
        print_asm_1("mov_rm2s", opr_src.data_size == 8 ? "b" : (opr_src.data_size == 16 ? "w" : "l"), len, &opr_src);
        opr_dest.type = OPR_SREG;
        operand_read(&opr_src);
        opr_dest.val = opr_src.val;
        operand_write(&opr_dest);
...
make_instr_func(mov_c2r_l){
        ...
        len += modrm_r_rm(eip + 1, &opr_dest, &opr_src); 
        print_asm_1("mov_c2r", opr_src.data_size == 8 ? "b" : (opr_src.data_size == 16 ? "w" : "l"), len, &opr_src);
        opr_src.type = OPR_CREG;
        operand_read(&opr_src);
        opr_dest.val = opr_src.val;
        operand_write(&opr_dest);
...
make_instr_func(mov_r2c_l){
        ...
        len += modrm_r_rm(eip + 1, &opr_dest, &opr_src); 
        print_asm_1("mov_r2c", opr_src.data_size == 8 ? "b" : (opr_src.data_size == 16 ? "w" : "l"), len, &opr_src);
        opr_dest.type = OPR_CREG;
        operand_read(&opr_src);
        opr_dest.val = opr_src.val;
        operand_write(&opr_dest);
